...
public class TestBinary {
    public static void main(String[] args) {
        ...
        if(!Binary.toString(binNum2).equals("0001_0001_0001_0001_0001_0001_0001_0001"))
        {
             System.out.println("FAIL Test 0B: ");
             System.out.println(" binNum from code: " + Binary.toString(binNum2));
             System.out.println(" correct binary string: 0001_0001_0001_0001_0001_0001_0001_0001");
        }
        else
        ...
        binNum3 = Binary.uDecToBin(64656, 32);
        binString = Binary.toString(binNum3);
        ...
        if(!(decNum == 286331153)) {
            ...
            System.out.println("    decimal number from code: " + decNum);
            System.out.println("    correct decimal number: " + 286331153);
        } else {
        ...
        if(!hexString.equals("1111_1111")) {
            System.out.println("FAIL Test 5B:");
            System.out.println("    hex string from code: " + hexString);
            System.out.println("    correct hex string: 1111_1111");
        } else {
        ...
        boolean[] twoSix = {true,false,false,true,true,true};
        if(!Arrays.equals(Binary.uDecToBin(57L,6), twoSix)) {
            System.out.println("FAIL Test 6B:");
            System.out.println("57 in 6 bits converted: " + Binary.toString(Binary.uDecToBin(57L,6)));
            System.out.println("Correct value: " + Binary.toString(twoSix));
        }
        else
        ...
        //and repeat what I did for Test 6A
        boolean[] twoFour = {true,true,true,false};
        if(!Arrays.equals(Binary.sDecToBin(-9L,4), twoFour)) {
            System.out.println("FAIL Test 6C:");
            System.out.println("-9 in 4 bits converted: " + Binary.toString(Binary.sDecToBin(-9L,4)));
            System.out.println("Correct value: " + Binary.toString(twoFour));
        }
        else

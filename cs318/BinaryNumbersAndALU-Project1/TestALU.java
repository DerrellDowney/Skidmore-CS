...
public class TestALU {
    public static void main(String[] args) {
        ...
        boolean[] binC = {false,true,true,true,false,false,true,true,true,true,false,true,true,true,false,true,true,true,true, true, true, true, true, true, false, true, true, false, true, true,true,true};
        //System.out.println(Binary.toString(binA));
        //System.out.println(Binary.toString(binB));
        //System.out.println(Binary.toString(binC));
        ...
        //STUDENT MUST ADD: add your own addCA (binC+binA with no signed overflow) and subCA (binC-binA, with a signed overflow)
        
        //no signed overflow
        boolean[] addCA = {false,false,true,true,true,true,false,true,false,false,true,false,false,true,true,true,true,false,true,false,false,false,true,false,true,true,true,false,true,true,false,false};
        
        //signed overflow
        boolean[] subCA = {false,false,false,false,false,true,true,true,false,true,false,false,true,false,false,true,true,false,false,true,true,true,false,true,false,true,true,false,true,true,false,true};
        ...
        if(!Arrays.equals(binRes, addCA)) {
            ...
            System.out.println("Correct result of binC + binA: " + Binary.toString(addAB));
        } else if(alu.getZeroFlag() || !alu.getCarryFlag() || alu.getOverflowFlag()) {
